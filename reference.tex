...
\begin{document}
% Gracias Demetrio
\def\title{Tecnológico de Monterrey Campus Guadalajara}
\centering{Por fin tenemos reference.}\\[0.2cm]
\centering{\includegraphics[width=5.5cm]{img/meme.png}}
\tableofcontents\newpage

%----------------------------------
% Descripciones, se puede quitar
...
\subsection{Prime count}
\cppfile{math/prime_count.cpp}
